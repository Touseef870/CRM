...
const StyledCard = styled(Card)(({ theme }) => ({
    width: '100%',
    maxWidth: 750,  // Reduced card width for better fit
    borderRadius: '16px',
    ...
    position: 'relative',  // Added relative positioning for delete button
    '&:hover': {
...
const CardHeader = styled(Box)(({ theme }) => ({
    ...
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between', // Make sure the name and avatar are aligned well
    marginBottom: theme.spacing(2),
    textAlign: 'left',
}));
...
function Page() {
    ...
    return (
        <>
            ...
            {/* Parent element ko `position: relative` ensure karein */}
        <Box sx={{ position: "relative" }}>
            <Button
                ...
                sx={{
                    ...
                    left: 16, // Stick to the left
                    padding: "8px 16px",
                    fontWeight: "bold",
                    textTransform: "none", // Optional: Normal case text
                    borderRadius: "8px",
                    boxShadow: "0 4px 8px rgba(0, 0, 0, 0.2)", // Add shadow
                    "&:hover": {
                        backgroundColor: "#005bb5", // Change hover color
                    },
                }}
            >
                Back
