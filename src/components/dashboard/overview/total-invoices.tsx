...
export function TotalInvoices({ value, sx, loading }: TotalInvoicesProps): React.JSX.Element {
          ...
          <Stack direction="row" sx={{ alignItems: 'flex-start', justifyContent: 'space-between' }} spacing={3}>
            <Stack spacing={1}>
              ...
              {loading ? (
                ...
                <Typography variant="h4" sx={{ marginTop: 5 }}>{animatedValue}</Typography> // Display animated value
              )}
            </Stack>
